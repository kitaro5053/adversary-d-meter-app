...
APP_VERSION = "0.25.0"  # ★2026-09-06昇格：カード原文表示（C3）・カード9枚現物確認（C1）・女の子♡3前提（C2）・
#   流布のTT読み（T12）・教師の除去/付与宣言（T13）・アルバイト×SK同時解決（T14）・T1〜T11（禁止エリア統一・ML引き離し・E1/E3・T8）。
#   旧0.24.0＝2026-08-17昇格（安定版が7/31版のまま17日分未反映だった件＝§72-36。
